...
def encryption(mainfile,protectfile,code):
    oldpdf = pikepdf.Pdf.open(mainfile)

    no_extr = pikepdf.Permissions(extract=False)

    oldpdf.save(protectfile,
            encryption= pikepdf.Encryption(user=code,
                                           allow=no_extr))
...
def protect():
    ...
    if mainfile == "" and protectfile == "" and code == "":
        ...
        try:
            ...
            encryption(mainfile,protectfile,code)
